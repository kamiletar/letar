 ...
 *
 * Портирован из `@letar/forms` (Chakra-скин) без изменений — использует те же framework-free
 * утилиты `@letar/forms-core/schema` (`traverseSchema`), которых достаточно для обоих скинов.
 */
