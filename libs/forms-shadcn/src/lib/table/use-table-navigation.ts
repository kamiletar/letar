 ...
 *
 * Портирован из `@letar/forms` (Chakra-скин) без изменений — framework-free логика, не зависит
 * ни от Chakra, ни от какой-либо UI-библиотеки (только React + DOM data-атрибуты).
 */
