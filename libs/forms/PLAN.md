...
- [ ] **7.3 `@letar/forms-shadcn` beta** — 15–20 ходовых полей (Input/Textarea/Number/Select/Checkbox/Radio/Date).
      ...
      **уже Chakra-free**, вопреки опасению, что «composition завязан на Chakra целиком».
      ...
      `FieldSwitch` → `TS2322`).
      - **Дальше:** PinInput/RichText/FileUpload/Address — оставшиеся ~2-7 полей до 15-20; либо
      дев-харнесс для визуальной проверки — порядок на усмотрение forms-dev, ничего не
      блокирует.
