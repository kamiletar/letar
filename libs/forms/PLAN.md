...
- Переписать README, `README.en.md`, `.claude/skills/zenstack-helper/reference/form-directives.md`,
  `form-mcp` → `get_directives`. **`form-mcp` синхронизировать обязательно** — иначе агенты будут
  продолжать писать `@form.*`, читая MCP, а не README.
