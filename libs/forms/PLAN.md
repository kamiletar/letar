...
Дальше: Фаза 9 (Vue-паритет `@letar/forms-vue`/`@letar/forms-vue-shadcn`) содержательно завершена
всеми 7 этапами. Следующая работа по форм-экосистеме — из backlog/входящих запросов, не отсюда.
