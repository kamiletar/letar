...
- [ ] **7.8 Тонкий Vue-адаптер (архитектурный пруф границы)** — 5–8 базовых полей
      ...
      действительно framework-agnostic** (верификация DIP-границы) + подарок Vue-комьюнити (теплее/благодарнее)
      + маркетинговая правда «проверено на React + Vue». ⚠️ **Это НЕ полный порт Vue** (все 56 полей + вся
