...
- **Приоритет:** high
- **Статус:** план составлен, реализация не начата. Узкая часть (наследование 7 атрибутов)
  закрыта отдельно в v2.3.0 — см. следующий пункт, он остаётся в силе и ничему тут не мешает.
