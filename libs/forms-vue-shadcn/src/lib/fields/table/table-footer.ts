...
import type { TableEditorController, TableFooterDef } from '@letar/forms-vue/core'
    ...
    return () => {
      ...
      return h('tfoot', {}, [
        h('tr', { class: 'font-bold' }, [
          controller.sortable && !controller.readOnly ? h('td', { class: 'p-2' }) : null,
          selectable && !controller.readOnly ? h('td', { class: 'p-2' }) : null,
          ...
          ...controller.columns.map((col) => {
            ...
            return h(
              ...
              {
                key: col.name,
                class: cn('p-2', col.align === 'right' && 'text-right', col.align === 'center' && 'text-center'),
              },
              agg
                ? [
                  agg.def.label ? h('span', { class: 'mr-1 text-muted-foreground' }, agg.def.label) : null,
          ...
          !controller.readOnly ? h('td', { class: 'p-2' }) : null,
        ]),
      ])
    }
  },
