...
⚠️ **Ещё не полный порт** — 39 из 61 поля React-скина (Этапы 1–4 закрыты целиком, Этап 5 — 7 из 8
тяжёлых peer-dep полей, остался только `FieldRichText`). Прогресс и план оставшихся этапов —
`libs/forms/PLAN.md`.
