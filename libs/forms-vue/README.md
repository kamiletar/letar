...
⚠️ **Ещё не полный порт** — 47 из 61 поля React-скина. Этапы 1–7 (из исходного плана 7 этапов)
закрыты, но сама декомпозиция на эти 7 этапов не покрывала список полностью — Этап 8 закрывает
найденный сверкой остаток (14 полей, 3 уже сделаны). Прогресс и план — `libs/forms/PLAN.md`.
