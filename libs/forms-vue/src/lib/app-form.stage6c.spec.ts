...
/**
 * Тот же макротасковый тайминг, что у `FieldRichText` (Этап 5б) — `defineAsyncComponent`'s
 * реальный `import()` резолвится через несколько макротасков, обычного `flushPromises()`/
...
describe('Этап 6 (часть 3) — FieldDataGrid', () => {
