...
`/api/cron/*` по расписанию) — [PLAN-INFRA.md §75](/PLAN-INFRA-4.md).
...
прод-`.env.docker` уже стоило пилотному приложению нескольких дней невыполненных задач
(13.08.2026): старые HTTP-ручки к тому моменту были удалены, а расписание не тикало. Поэтому
