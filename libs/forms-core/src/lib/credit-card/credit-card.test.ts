...
describe('formatCardNumber', () => {
  ...
  it('дописывает цифры сверх суммы gaps без разделителя (Visa 19 цифр, Фаза 8)', () => {
    // 4+4+4+4=16 сгруппированных, дальше — хвост без пробела внутри группы
    expect(formatCardNumber('4111111111111111123')).toBe('4111 1111 1111 1111 123')
  })

  it('не дорисовывает пробел для незаполненной последней группы (движок masks, Фаза 8)', () => {
    expect(formatCardNumber('411111111111112')).toBe('4111 1111 1111 112')
  })
})
