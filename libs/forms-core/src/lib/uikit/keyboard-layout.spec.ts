...
describe('correctKeyboardLayout: запятая и точка — это «б» и «ю»', () => {
  it('«бани» в EN-раскладке', () => {
    expect(correctKeyboardLayout(',fyb')).toBe('бани')
  })

  it('«юла» в EN-раскладке', () => {
    expect(correctKeyboardLayout('.kf')).toBe('юла')
  })
})
