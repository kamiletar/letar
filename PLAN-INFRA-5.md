...
> ⚠️ 2026-09-06: та же задача была заведена второй раз как [§157](/PLAN-INFRA-6.md) — без ссылки сюда и без части
> проработанных здесь вопросов. Аудит §157 (там же, в конце секции) разбирает оба варианта и рекомендует
> свести их в одну секцию (старшая — эта).
