...
⚠️ Ссылка на новый док в индекс `CLAUDE.md` не добавлена: файл на момент работы был в состоянии
`MM` (чужая правка параллельной сессии с рассинхроном индекса — ровно мина из §119), трогать его
означало забрать чужое. Добавить ссылку при следующей правке `CLAUDE.md`.
