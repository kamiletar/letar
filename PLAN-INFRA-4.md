...
закрыт мейнтейнером как `not_planned` — причину тогда не нашли. Черновик нового issue с разбором
и однострочным фиксом подготовлен, публикация ждёт решения владельца.

⚠️ **Не выкачено:** оба коммита (`8f610b5a` патч, `47c4754b` доки) лежат локально, push ждёт
одобрения владельца.
