...
- **`rootDir`** — встречался в исходных конфигах (`.`, `"../.."`, `"src"`), изначально выброшен
  ...
  **Обоснование оказалось неверным** (2026-08-07): после того как `references` на `libs/*` убрали
  ...
  что все приложения на пресете лежат на одинаковой глубине (`apps/<app>/tsconfig.json`).
  ⚠️ До 2026-09-03 здесь было «все 19 приложений»; на 2026-09-03 их 21
  (`grep -rl 'tsconfig.next-app.json' apps/*/tsconfig.json | wc -l` — рекурсивный `grep`, не
