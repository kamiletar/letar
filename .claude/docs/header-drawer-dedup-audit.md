...
**Предложение (не реализовано):** локальный shared-компонент в самом grandslamcup —
...
можно делать по запросу владельца grandslamcup; не сделано в рамках этой сессии, т.к. задача была
исследовательская для aboi, а правки в grandslamcup — другой scope/agent-mail резервация.
