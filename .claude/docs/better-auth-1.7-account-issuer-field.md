...
Затронуто **14 приложений монорепо** (полный список и статус деплоя по каждому — `PLAN-JOURNAL-2.md` §71),
не 4, как считалось на первом проходе (`PLAN-JOURNAL-2.md` §59, 2026-08-25).
...
живая проверка входа/logout по каждому — `PLAN-JOURNAL-2.md` §71.
