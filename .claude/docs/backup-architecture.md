...
> формулировка, и она была верной ровно до переезда s3 с NPM на Traefik ([PLAN-INFRA.md §48 M2](/PLAN-INFRA.md)). Теперь на s3 лежит **невосстановимое**: три per-name аккаунта acme-dns
...
> ⚠️ **Известные пробелы (2026-08-19, после двух итераций расширения списка):** переиндексация
> сократила число отслеживаемых записей с ~5292 до ~2858 (2я итерация). Остаток — длинный хвост
> мелких git-tracked файлов в приложениях с уникальной структурой, не подпадающих под общие
> паттерны: одноразовые подпроекты (`apps/animatrona/web-player`, `mobile-ui`), инфра-скрипты
...
> Добавлен 2026-08-07, dashboard-agent 0.10.0. Трек — [PLAN-INFRA.md §48](/PLAN-INFRA.md).
