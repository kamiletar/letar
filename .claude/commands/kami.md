...
ОБЯЗАТЕЛЬНО при старте сессии зарегистрируйся под фиксированным именем `kami-dev`.
...
macro_start_session(
  ...
  task_description: "Разработка kami: <что делаешь>",
  file_reservation_paths: ["apps/kami/**"],
  file_reservation_reason: "kami development"
)
```
