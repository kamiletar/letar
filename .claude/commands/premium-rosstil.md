# Premium Rosstil - Воркфлоу разработки

## Инициализация

1. Прочитай `.claude/rules/premium-rosstil.md` для специфичных правил
2. Прочитай `apps/premium-rosstil/PLAN.md` для текущего состояния задач
...
**Приложение:** premium-rosstil
**Порт:** 3000
**Описание:** Fashion интернет-магазин
**Правила:** `.claude/rules/premium-rosstil.md`
