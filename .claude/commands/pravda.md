...
ОБЯЗАТЕЛЬНО при старте сессии зарегистрируйся под фиксированным именем `pravda-dev`.
...
macro_start_session(
  ...
  agent_name: "pravda-dev",
  registration_token: "<токен из agent_fixed_names_tokens.md>",
  task_description: "Разработка pravda: <что делаешь>",
  file_reservation_paths: ["apps/pravda/**"],
  file_reservation_reason: "pravda development"
)
```
