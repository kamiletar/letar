...
ОБЯЗАТЕЛЬНО при старте сессии зарегистрируйся под фиксированным именем `mandala-dev`.
...
macro_start_session(
  ...
  agent_name: "mandala-dev",
  registration_token: "<токен из agent_fixed_names_tokens.md>",
  task_description: "Разработка mandala: <что делаешь>",
  file_reservation_paths: ["apps/mandala/**"],
  file_reservation_reason: "mandala development"
)
```
