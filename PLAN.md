...
>
> **➡️ Следующий старт:** тираж §2.3/Этап 8 на aboi и driving-school завершён (см. записи выше).
> Дальше — Этап 8.5 (несколько email на аккаунт); затем фикс dsperevod seed.ts (bcrypt/scrypt,
