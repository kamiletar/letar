...
> ⏳ Следующее: установить key на s2 (`/home/deploy/.age/letar-key.txt` + `SOPS_AGE_KEY_FILE` в bashrc), тираж на остальные приложения.
> **➡️ Следующий старт:** установить age-ключ на s2 → тираж SOPS на остальные приложения, или **Этап 8.5** owner-миграции на s2.
...
### Этап 0.4 — Выделенный secret-manager для кредов ✅ ПИЛОТ (2026-06-11) ⏳ тираж
