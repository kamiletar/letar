...
> для s2-only apps. **⏳ Ждём деплоя** dashboard-agent от BlackCove для финального закрытия DoD 0.3.
> **➡️ Следующий старт:** дождаться деплоя (BlackCove), затем **Этап 4** (premium-rosstil миграция на Better Auth).
...
### Этап 0.3 — Ревизия системы бэкапов (прод + локальные) ⏳ ПОЧТИ ЗАКРЫТ (2026-06-04)
