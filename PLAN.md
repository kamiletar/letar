...
владельца по `svoichuzhie` (см. Блокеры ниже). Эта сессия — внеплановая ранняя проверка бэкапов Maddy
после инцидента 2026-07-28 (Этап 0.3): вскрыт и починен **второй, независимый** баг в той же цепочке —
подробности в §42.
