...
технический.
**Следующий шаг:** 5 коммитов этой сессии (группы A/B/C/D + docs/`.gitignore`) сделаны, не запушены.
Осталось: решить с владельцем svoichuzhie вопрос отдельной РКН-регистрации → после подачи дозаполнить
плейсхолдеры на `svoichuzhie.ru/privacy` → проставить галочки чеклиста Этапа 0.8 по каждому приложению.
