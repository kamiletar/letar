...
**Активный фронт:** §27 Часть 3 (структура `PLAN.md`) **завершена** — блок СТАТУС, «§0 Открытые
хвосты», три противоречия 3.3, снимок §3, легенда+маркеры 3.6, коллизия §21→§28 закрыты.
**Блокеры:** —
**Следующий шаг:** §27 Часть 2 Шаг 2.5 — тот же приём чистки коммерческих деталей (уже применён
к `PLAN.md`) применить к `PLAN_COMPLETED.md` (102 упоминания) и `PLAN-INFRA.md` (64). `PLAN.md`
всё ещё ~1650 строк (ориентир ~1200) — если понадобится дальше сокращать, вынести оставшийся
§7-иллюстративный контент по приложениям (Шаг 2.1, не завершён). Детали и DoD — §27 в конце файла.
