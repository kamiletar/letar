...
> self-service email частично завершён (см. записи выше — вход по любому linked-email и merge
> двух аккаунтов остаются отдельными задачами). Дальше — фикс dsperevod seed.ts (bcrypt/scrypt,
