...
> ⏳ Следующее: установить age-ключ на s2 (`/home/deploy/.age/letar-key.txt` + `SOPS_AGE_KEY_FILE` в bashrc).
> **➡️ Следующий старт:** установить age-ключ на s2, или **Этап 8.5** owner-миграции на s2.
