...
> `infra/firewall/docker-user-firewall.sh` и должна применяться на всех трёх серверах (s2, s3,
> mail), не только на s2 — s3/mail пока не проверены этой же живой пробой.
