...
## §56 — Список cron-задач на проде расходится с кодом, и код почти ничего не может с этим сделать 🟡 ЧАСТИЧНО — зомби-проверка чистая 2026-09-02, остался один пункт (решение владельца по `schedule`) (2026-08-07, RETIRED_JOB_IDS — 2026-08-09)
