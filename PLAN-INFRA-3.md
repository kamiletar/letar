...
## §52 — Cron-задачи агента к приложениям падают с `HTTP 401` 🟡 ЧАСТИЧНО — root cause и все диагностические пункты закрыты 2026-09-02, остались два улучшения сигнализации (2026-08-07, дедуп+логирование алертов — 2026-08-09)
