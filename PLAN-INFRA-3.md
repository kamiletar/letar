...
## §60 — Инфраструктурные сервисы на серверах живут вне git: фикс в репозитории не доезжает до прода 🟡 ЧАСТИЧНО — s2/s3 закрыты 2026-09-02, остаётся mail-сервер (заведено 2026-08-08, приоритет поднят 2026-08-28)
