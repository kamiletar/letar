...
## §60 — Инфраструктурные сервисы на серверах живут вне git: фикс в репозитории не доезжает до прода 🔥 ПРИОРИТЕТ (заведено 2026-08-08, приоритет поднят 2026-08-28)
