...
[§63](/PLAN-INFRA-4.md)). Второй вариант — build-зависимость `animatrona-pinner3`
...
существовал на mail-сервере (ни контейнера, ни образа, [§57](/PLAN-INFRA-3.md)). Реальный
...
[PLAN-INFRA-3.md §57](/PLAN-INFRA-3.md).
...
экземпляр — вручную скопирован в `/opt/pin-queue`, без git ([§60](/PLAN-INFRA-3.md)). Новый деплой
...
([§63](/PLAN-INFRA-4.md)). Если решите использовать именно его вместо standalone — сначала явно
...
Перепись и план перевода на git — [PLAN-INFRA.md §60](/PLAN-INFRA-3.md). Правка любого файла здесь
