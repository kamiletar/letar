...
там же; ⚠️ с 2026-09-19 старый s3 отключён, роль у нового s3 `185.130.251.234` — PeerId
при переносе сохранён, PLAN-INFRA-6.md §188). Это ДРУГОЙ узел с другим PeerId, не переезд этого
