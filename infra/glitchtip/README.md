...
| `dashboard` | ⏳ не создан  | код готов (2026-08-11, `glitchtip-integrate`), DSN не заполнен, не задеплоено |
| `time`      | ⏳ не создан  | код готов (2026-08-11, `glitchtip-integrate`), DSN не заполнен, не задеплоено |
