...
- [ ] Проверить глазами на зернистом рипе (кадр 1:1, tf0 против tf4), не съедает ли фильтр
      зерно, которое хочется сохранить. Если съедает — в профиле «Архив» фильтр выключить.
