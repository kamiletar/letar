...
| Имя nx-проекта                       | `apps/animatrona-viewer` — по аналогии с `animatrona-folder-player`, не путается с `animatrona-tracker` (это отдельный веб-каталог/модерация, не desktop-клиент)                                                                                                                                               |
