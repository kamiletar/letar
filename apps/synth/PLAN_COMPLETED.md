...
## Сессия 2026-07-08 (продолжение 2) — Приём SysEx-дампа с железа
...
- **Ручная проверка на реальном SMK-37 — за пользователем** (Web MIDI SysEx недоступен в сэндбоксе превью; нужно подтвердить, что устройство действительно отвечает на дамп-запрос форматом `F0 43 2n 00 F7`).
