/**
 * Физическая раскладка клавиатуры — 5 рядов ANSI с русской раскладкой (ЙЦУКЕН).
 *
 * Общий источник данных для визуальной клавиатуры редактора (renderer,
 * `editor/keyboard-data.ts`) и нативного GDI-оверлея (main, `src/overlay.ts`) — раньше это были
 * два независимых копии одних и тех же значений.
 */
