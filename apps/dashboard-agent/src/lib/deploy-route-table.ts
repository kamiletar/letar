 ...
 * ⚠️ Три константы ниже (ROUTE_HEADER_RE, LEGEND_RE, BLANK_RE) должны совпадать с копией в log-tools.ts
 * дословно: синхронность стережёт scripts/check-route-table-regex-sync.mjs (`bun scripts/check-all.mjs`),
 * правь обе копии в одном коммите.
 */
