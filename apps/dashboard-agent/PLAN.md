...
- [ ] Проактивное сканирование логов контейнеров на ошибки + алерт (по аналогии с
      `lib/health-check.ts`) — pull-доступ к логам есть, автоматического обнаружения
      новых ошибок и уведомления в dashboard нет.
