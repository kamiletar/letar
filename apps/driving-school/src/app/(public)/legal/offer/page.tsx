...
export const metadata = {
  title: 'Договор-оферта | НаПрава.РФ',
  description: 'Публичный договор-оферта на оказание услуг платформы для автошкол',
}

export default async function OfferPage() {
  const document = await legalService.getDocumentBySlug('offer')
        ...
        {document?.currentVersion ? (
          ...
          <Box p={8} bg="bg.subtle" borderRadius="lg" textAlign="center">
            <Text color="fg.muted" mb={4}>
              Договор-оферта находится в разработке.
            </Text>
