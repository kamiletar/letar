...
/**
 * Semantic color tokens для time приложения
 *
 * Цветовая схема: изумрудно-зелёный (emerald) в стиле Kami/Matrix
...
export const semanticColors = defineSemanticTokens.colors({
  ...
  bg: {
    DEFAULT: {
      value: { _light: '{colors.gray.50}', _dark: '#0D0D0D' },
    },
    surface: {
  ...
  /* ===========================
     Foregrounds — изумрудно-зелёный в стиле Kami
  =========================== */
  fg: {
    DEFAULT: {
  ...
  /* ===========================
     Brand (Primary) - Изумрудно-зелёный
  =========================== */
  brand: {
    solid: {
