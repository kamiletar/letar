...
- JetBrains Mono переведён с `next/font/google` на `next/font/local` — сборка больше не ходит в
  сеть за шрифтом. Разбор для приложения на 40 локалей — какие скрипты шрифт физически не
  покрывает (CJK, арабский, иврит, армянский, грузинский, деванагари, тамильский/телугу,
  тайский — не регрессия, было так и раньше) и известный не новый пробел (казахские/таджикские
  буквы Қ/ҷ/ӣ в `locale-switcher.tsx`) — в `src/app/fonts/README.md`.
