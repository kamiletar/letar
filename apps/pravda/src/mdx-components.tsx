...
import {
  ...
  TableHeader,
  TableRow,
} from '@/app/_components/mdx'

/**
 * Стилизованный pre элемент для блоков кода.
 * Используем Box вместо chakra() для совместимости с Server Components.
 */
 ...
 * Добавляет специальные компоненты для законодательных документов.
 */
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    // Таблицы (стандартные HTML -> Chakra)
    table: LawTable,
    thead: TableHeader,
    tbody: TableBody,
    tr: TableRow,
    ...
    // Специальные компоненты для законов
    Article,
    Section,
    Chapter,
    CrossRef,
