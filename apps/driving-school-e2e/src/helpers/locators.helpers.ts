 ...
 *
 * Устраняет 49 случаев .chakra-* селекторов
 */
...
export const Locators = {
  ...
  /**
   * TagsInput — теги (для районов, категорий и т.д.)
   */
 ...
 *
 * @example
 * const card = getCardByText(page, 'Занятие с Иваном')
 * await card.click()
 */
 ...
 *
 * @example
 * await getTab(page, 'Настройки').click()
 */
 ...
 *
 * @example
 * await getRadio(page, 'Ученик').click()
 */
 ...
 *
 * @example
 * await getLink(page, 'Регистрация').click()
 */
