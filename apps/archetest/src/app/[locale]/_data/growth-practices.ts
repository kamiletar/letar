...
export const GROWTH_PROFILES: GrowthProfile[] = [
  // ===== Кластер A =====
  {
    ...
    practices: [
      {
        text:
          'Когда ловите себя на тревожной интерпретации чужого поступка, выпишите её и рядом — 2–3 других объяснения того же факта. Спросите: какие доказательства есть за каждое? Так вы отличаете реальный сигнал от тени.',
        textEn:
      ...
      {
        text:
          'Раз в неделю проводите маленький «эксперимент на доверие»: сделайте один шаг навстречу человеку из ближнего круга, не выжидая подвоха, и отметьте, что произошло на самом деле. Реальность обычно мягче прогноза.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Дозируйте социальность как ресурс, а не как обязанность: запланируйте один короткий, заранее ограниченный по времени контакт в неделю (30–40 минут). Предсказуемые рамки снимают напряжение от «неизвестно, сколько это продлится».',
        textEn:
      ...
      {
        text:
          'Замечайте моменты, когда за автономией прячется старое правило «близость небезопасна». Назовите это правило вслух — уже само называние ослабляет его власть над выбором.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Заведите привычку «догадка → проверка»: перед тем как поверить яркой интуитивной связи, ищите один факт, который её опровергнет. Интуиция ценнее, когда проходит проверку реальностью, а не заменяет её.',
        textEn:
      ...
      {
        text:
          'Когда поток образов и смыслов перегружает, используйте заземление 5-4-3-2-1: назовите 5 вещей, которые видите, 4 — которые слышите, и так далее. Это возвращает в «здесь и сейчас» без потери вашей нестандартности.',
        textEn:
  ...
  // ===== Кластер B =====
  {
    ...
    practices: [
      {
        text:
          'Перед импульсивным решением вставьте паузу «СТОП»: остановитесь, сделайте шаг назад, оцените, что поставлено на карту, действуйте осознанно. Ваша решительность выигрывает, когда за ней стоит секунда выбора.',
        textEn:
      ...
      {
        text:
          'В решениях, задевающих других, добавьте один вопрос: «кто заплатит за это и согласен ли он?». Учёт цены для окружающих превращает бесстрашие из риска в лидерство.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'На пике сильной эмоции примените TIPP: холодная вода на лицо, интенсивная нагрузка на 5 минут, замедленное дыхание. Это физиологически сбивает накал за минуты и возвращает способность выбирать.',
        textEn:
      ...
      {
        text:
          'Когда порыв тянет сделать резкое, попробуйте «противоположное действие»: если хочется хлопнуть дверью — мягко проговорите, если хочется исчезнуть — останьтесь на пять минут. Действие против волны учит её не бояться.',
        textEn:
      ...
      {
        text:
          'Ведите короткий дневник эмоций: ситуация → чувство → его сила 0–100 → что помогло. Через пару недель проявляются ваши триггеры и работающие опоры — карта, по которой шторм становится управляемым.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Раз в день делайте что-то ценное без свидетелей и без публикации. Опыт «я значим, даже когда никто не смотрит» строит внутреннюю опору, независимую от отклика зала.',
        textEn:
      ...
      {
        text:
          'В разговоре тренируйте паузу-слушание: задайте вопрос и удержитесь от того, чтобы перевести фокус на себя, пока собеседник не договорит. Ваша харизма усиливается, когда светит и на других.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Тренируйте эмпатию как навык, а не ждите как чувство: в спорной ситуации сформулируйте позицию оппонента так, чтобы он сказал «да, именно это я и имел в виду». Перспектива другого — точка роста вашей уверенности.',
        textEn:
      ...
      {
        text:
          'Раз в неделю признавайте вслух один свой промах без «но». Способность выдержать несовершенство без обрушения самооценки — признак не слабой, а зрелой уверенности.',
        textEn:
  ...
  // ===== Кластер C =====
  {
    ...
    practices: [
      {
        text:
          'Составьте лестницу из социальных ситуаций от лёгкой к трудной и поднимайтесь по одной ступени в неделю, оставаясь в ситуации, пока тревога не спадёт сама. Постепенная экспозиция расширяет зону комфорта без насилия над собой.',
        textEn:
      ...
      {
        text:
          'Когда предсказываете отвержение, проверьте прогноз фактом: сделайте шаг и запишите, что произошло на самом деле. Со временем накопится доказательство, что мир критичен к вам меньше, чем кажется.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Тренируйте самостоятельные решения на малом: раз в день выбирайте что-то (еду, маршрут, фильм) без сверки с чужим мнением. Мышца автономии растёт от повторов, а не от одного большого шага.',
        textEn:
      ...
      {
        text:
          'Освойте одну ассертивную формулу: «Я понимаю тебя, и при этом мне важно…». Прямая просьба без извинений за собственные потребности — навык, который защищает вашу заботу от превращения в самоотречение.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Введите правило «достаточно хорошо»: для рутинных задач заранее назначьте уровень качества 80% и остановитесь на нём. Освободившийся ресурс вкладывайте туда, где точность действительно критична.',
        textEn:
      ...
      {
        text:
          'Раз в неделю намеренно оставляйте одну мелочь несовершенной и наблюдайте, что ничего не рушится. Толерантность к неопределённости тренируется малыми дозами и делает вашу силу гибче.',
        textEn:
  ...
  // ===== Состояния (не черты) =====
  {
    ...
    practices: [
      {
        text:
          'Стабилизируйте «водители ритма»: держите постоянное время сна и подъёма даже в выходные. Регулярность режима — одна из самых доказанных опор при перепадах настроения.',
        textEn:
      ...
      {
        text:
          'Ведите простой трекер настроения и энергии (шкала 1–10 утром и вечером). Ранние сигналы подъёма или спада, замеченные за дни до пика, дают время принять меры — и материал для разговора со специалистом.',
        textEn:
      ...
      {
        text:
          'Цикличность настроения хорошо отзывается на сопровождение специалиста. Если волны мешают жить, разговор с психотерапевтом или психиатром — не «крайняя мера», а точная работа с состоянием, которое поддаётся коррекции.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Замените непрямой протест на одну прямую фразу: «Я не согласен с этим, потому что…». Прямое «нет» ощущается рискованным, но снимает груз накопленного раздражения куда надёжнее, чем промедление или сарказм.',
        textEn:
      ...
      {
        text:
          'Когда чувствуете глухое сопротивление, спросите себя: «чего я на самом деле хочу в этой ситуации?» и озвучьте это как просьбу, а не как претензию. Названная потребность превращает тихий бунт в диалог.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Используйте поведенческую активацию: запланируйте одно маленькое приятное или осмысленное действие в день и сделайте его, не дожидаясь настроения. Действие часто идёт первым, а желание подтягивается за ним.',
        textEn:
      ...
      {
        text:
          'Ловите самокритичную мысль и переформулируйте её так, как сказали бы близкому другу. Ваша глубина остаётся, но фильтр «я во всём виноват» смягчается до «мне сейчас трудно, и это объяснимо».',
        textEn:
      ...
      {
        text:
          'Если пропадает радость и силы надолго — это повод не «взять себя в руки», а обратиться к специалисту. Депрессивный фон корректируется терапией, не отнимая у вас способность видеть глубоко.',
        textEn:
  ...
  // ===== Тёмная триада =====
  {
    ...
    practices: [
      {
        text:
          'В следующих переговорах поставьте цель win-win: найдите исход, при котором выигрывают обе стороны, и предложите его открыто. Стратегия, переведённая в честную сделку, строит репутацию, которая работает на вас годами.',
        textEn:
      ...
      {
        text:
          'Раз в неделю сознательно выбирайте прозрачность там, где привычнее скрытый ход: скажите о своём интересе прямо. Доверие — единственный ресурс, который расчёт не может подделать, но может накопить.',
        textEn:
  ...
  // ===== Светлая триада =====
  {
    ...
    practices: [
      {
        text:
          'Введите «границу заботы»: заранее решите, сколько ресурса вы отдаёте, и оставьте часть себе без чувства вины. Забота о себе — не эгоизм, а условие, при котором вашего тепла хватит надолго.',
        textEn:
      ...
      {
        text:
          'Раз в день замечайте сигналы собственной усталости так же внимательно, как чужую боль. Если вы регулярно опустошены — это не «мало старания», а звонок о том, что пора восстановиться.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Перед тем как вынести моральный вердикт, добавьте вопрос о контексте: «что я не знаю о ситуации этого человека?». Правило существует ради людей, а не наоборот — контекст возвращает принципам человечность.',
        textEn:
      ...
      {
        text:
          'Потренируйте гибкость на малом: раз в неделю сознательно сделайте исключение из собственного правила там, где цена ошибки невелика. Принцип, который умеет гнуться, крепче того, что ломается.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Примите принцип «доверяй и проверяй»: давайте аванс доверия, но привязывайте его к небольшим проверяемым шагам. Доверие как осознанный выбор ценнее, чем доверие как слепота, — и защищает вас от тех, кто им пользуется.',
        textEn:
      ...
      {
        text:
          'Когда замечаете, что кто-то раз за разом обходится с вашим доверием как с ресурсом, разрешите себе назвать это вслух. Ваша вера в людей не обязана быть безусловной, чтобы оставаться настоящей.',
        textEn:
  ...
  // ===== Деструктивные паттерны =====
  {
    ...
    practices: [
      {
        text:
          'Направляйте азарт борьбы в арены с правилами: спорт, дебаты, стратегические игры, конкурентные проекты. Там ваша жёсткость — сила и драйв, а не риск задеть того, кто не подписывался на схватку.',
        textEn:
      ...
      {
        text:
          'Тренируйте эмпатию как навык: в момент чужого проигрыша задержитесь на секунду и назовите, что сейчас чувствует другой. Если чужая боль радует сама по себе, без выгоды для вас, — это сигнал присмотреться к себе.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Раз в день делайте выбор в пользу лёгкого пути там, где привыкли выбирать трудный, и отслеживайте, что мир не наказывает за это. Страдание не обязано быть ценой за право чувствовать себя настоящим.',
        textEn:
      ...
      {
        text:
          'Практикуйте самосострадание: в трудный момент обратитесь к себе теми словами, которыми поддержали бы близкого. Если вы систематически выбираете то, что причиняет боль, — это паттерн, а не судьба, и он поддаётся терапии.',
        textEn:
  ...
  // ===== Спектр развития =====
  {
    ...
    practices: [
      {
        text:
          'Настройте среду под себя: договаривайтесь о прямых, буквальных правилах вместо намёков, закладывайте время на восстановление после «людных» дней. Это не слабость, а грамотное управление своим ресурсом внимания.',
        textEn:
      ...
      {
        text:
          'Снижайте сенсорный шум точечно: наушники, приглушённый свет, паузы в тишине — заранее, а не когда уже перегружены. Регуляция сенсорики до пика утомления сохраняет вашу главную силу — глубину фокуса.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Перед тем как сказать неудобную правду, задайте один вопрос: «просят ли её сейчас?». Не всякая правда — подарок, если её не просили; честность плюс такт бьёт сильнее, чем честность в лоб.',
        textEn:
      ...
      {
        text:
          'Тренируйте «правду в обёртке»: сначала назовите намерение («хочу помочь, а не задеть»), потом факт. Готовность собеседника услышать вырастает, и ваша прямота начинает работать на отношения, а не против них.',
        textEn:
  ...
  },
  {
    ...
    practices: [
      {
        text:
          'Расширяйте словарь эмоций: держите под рукой список из 10–12 чувств и раз в день выбирайте то, что ближе всего к текущему состоянию. Называние — навык, и он тренируется, как любой другой.',
        textEn:
      ...
      {
        text:
          'Читайте эмоции через тело: заметив напряжение, усталость или ком в горле, спросите «какое чувство могло бы так звучать?». Ваши эмоции не отсутствуют — они говорят на языке тела, и его можно научиться переводить.',
        textEn:
