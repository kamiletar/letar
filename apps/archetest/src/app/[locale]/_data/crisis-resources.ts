 ...
 *
 * ⚠️ Телефон доверия — функция безопасности: неверный номер хуже отсутствия номера.
 * Проверено 2026-07-09 по открытым источникам (mchs.gov.ru — линия ЦЭПП действует
 * круглосуточно; fond-detyam.ru — детская линия работает). Перепроверить звонком
 * в буферную неделю перед фестом (входит в демо-чек-лист).
