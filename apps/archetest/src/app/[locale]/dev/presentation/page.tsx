      ...
      <VStack gap={8} align="stretch">
        ...
        <Slide number="03 · Визуализация" title="Гексаграмма: Свет и Тень — не противоположности">
          <SimpleGrid columns={{ base: 1, md: 2 }} gap={6} w="100%" alignItems="center">
            ...
            <VStack align="start" gap={3}>
              ...
              <Bullet>
                Триады — <b>независимые измерения</b> (Kaufman et al., 2019: r ≈ −.48). Высокие баллы по обеим — норма
                данных, не парадокс.
              </Bullet>
              <Bullet>
              ...
              <Bullet>
                Зона пересечения — визуальная метафора интеграции, <b>не психометрическая метрика</b> — оговорка прямо в
                интерфейсе.
              </Bullet>
        ...
        <Slide number="04 · Философия результатов" title="От диагностики — к карте ресурсов">
          <Bullet>
            ...
            <b>Ловушка</b> (когда вредит, без стигмы) → <b>Практики</b> (конкретные действия с тегом модальности: КПТ,
            DBT, схема-терапия).
          </Bullet>
          <Bullet>
            Клинические названия пользователь <b>не видит вообще</b> — только архетипы («Гроссмейстер», «Маяк»,
            «Целитель»). Клиника — в кабинете психолога.
          </Bullet>
          <Bullet>
          ...
          <Bullet>
            Ведущие черты — <b>ипсативные ранги с 95%-интервалами точности</b>: шкалы сравниваются внутри профиля;
            статистически неразличимые соседи так и подписываются — никакой ложной точности «61,2% &gt; 60,8%».
          </Bullet>
        </Slide>
        ...
        <Slide number="06 · Этика и право" title="152-ФЗ, согласие и безопасность — по-настоящему">
          ...
          <Bullet>
            Информированное согласие <b>до</b> первого вопроса, чекбокс не предотмечен; полная политика
