 ...
 *
 * Animatrona — некоммерческая витрина desktop-приложения без форм сбора ПДн
      ...
      <main>
        ...
        <Container maxW="3xl" py={{ base: 16, md: 24 }}>
          <VStack gap={6} align="stretch">
            ...
            <Text>
              Сайт Animatrona — некоммерческая витрина desktop-приложения для управления аниме-коллекцией. Мы не
