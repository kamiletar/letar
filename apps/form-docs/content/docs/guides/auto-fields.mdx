...
source at build time. The chakra source uses `Form.AutoFields`; the shadcn source uses `FieldAuto`
— a different level of the control hierarchy below, but the same idea of generating fields
automatically from a Zod schema. No Vue/Angular equivalent exists yet — those tabs show as disabled.

<SkinCodeFile
  chakra="apps/form-develop-app/src/app/auto-fields-demo/page.tsx"
  shadcn="apps/form-develop-app-shadcn/src/app/auto-fields-demo/page.tsx"
/>
