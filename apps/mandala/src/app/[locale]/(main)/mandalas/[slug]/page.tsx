...
export async function generateStaticParams() {
  try {
    ...
    // БД недоступна при билде — страницы будут генерироваться динамически. Ошибку обязательно
    // печатаем: без неё пустой список неотличим от «нет опубликованных записей» (сборка на s1
    // читает БД через SSH-туннель, PLAN-INFRA-6.md §157, и тихий отказ там не виден в логе)
    console.error('[generateStaticParams] mandalas/[slug]: БД не прочитана, страницы пойдут динамически', error)
    return []
  }
}
