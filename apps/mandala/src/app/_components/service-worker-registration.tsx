...
export function ServiceWorkerRegistration() {
  const { isAccepted } = useOfflineConsent('mandala-offline-consent')
    ...
    const handleRegistration = async () => {
      if (isAccepted) {
        ...
        try {
          ...
          console.warn('[SW] Service Worker зарегистрирован:', registration.scope)
        ...
        if (registrationRef.current) {
          try {
            ...
            console.warn('[SW] Service Worker отменён')
          } catch (error) {
