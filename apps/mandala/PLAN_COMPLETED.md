...
`05-full-checkout.guest.spec.ts`, использующих один и тот же клик. ⚠️ Не задеплоено и не
подтверждено полным прогоном на этот коммит — код готов, но заявление «unexpected → 0» пока не
проверено.
