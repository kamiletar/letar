...
/**
 * MenuContent - контент меню с поддержкой Portal
 */
...
/**
 * MenuCheckboxItem - элемент меню с checkbox
 */
...
/**
 * MenuRadioItem - элемент меню с radio
 */
 ...
 */
export const MenuItemGroup = React.forwardRef<HTMLDivElement, ChakraMenu.ItemGroupProps & { title?: React.ReactNode }>(
...
/**
 * MenuTriggerItem - элемент меню, который открывает подменю
 */
