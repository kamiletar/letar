 ...
 * - staleTime: 5 минут
 * - retry: 2
 * - DevTools включены в development (Query + Form)
 *
 * Примечание: ZenStack v3 ORM не использует tanstack-query hooks,
 * данные получаются через Server Actions и ORM напрямую.
 */
