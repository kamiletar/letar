...
/**
 * Кольцо прогресса с треком и заполнением
 */
...
/**
 * Текст со значением в центре круга
 */
...
export const ProgressCircle = {
  ...
  Ring: ProgressCircleRing,
  ValueText: ProgressCircleValueText,
  Circle: ChakraProgressCircle.Circle,
  Track: ChakraProgressCircle.Track,
  Range: ChakraProgressCircle.Range,
}
