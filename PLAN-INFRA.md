...
Сломалась 2026-08-02 около 10:40 MSK (07:40 UTC) (596 × 15 минут) после 11 дней зелёного — настоящая смена
...
2026-08-08 ~15:04 MSK (12:04 UTC), сделанный по другому поводу, снял её побочно. Проверяется тем, сбросился ли
...
- [ ] Подтверждена причина подвеса internal-ноги (см. выше — возможно, снята рестартом 15:04 MSK)
