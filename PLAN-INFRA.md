...
**Остаточная уборка (не срочно):** если на s2 остались конфиг NPM под это имя и каталог кеша —
убрать. Мёртвый конфиг безвреден, но 2 ГБ мусора на прод-сервере лучше не держать, а живой конфиг
под чужим именем — готовая ловушка для следующего, кто будет разбираться в маршрутах. Запрошено у
BlackCove замером: наличие конфига + размер и **mtime** каталога (живой кеш и заброшенный в `du`
неразличимы).
