...
## §37 — Публикация в npm открыта для публичной части монорепо; `libs/ui` к ней не готов 🆕 (2026-07-30)
...
## §39 — Шаблон `.gitignore` для приватных submodule уже́ корневого: `uploads/` не закрыт 🆕 (2026-08-04)
