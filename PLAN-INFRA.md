...
- Токен `AUTH_TOKEN` этого сервиса лежит открытым текстом в публичном репозитории
  (`apps/animatrona/main/services/ipfs/pin-queue-poller.ts:23`) — отдельный вопрос ротации,
  поднят владельцу 2026-08-08.
